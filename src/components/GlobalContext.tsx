...
import type { Emissions, Region } from "../types";
...
export default function GlobalContext({ emissions, hasCalculated }: GlobalContextProps) {
    ...
    >
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: "var(--space-10)" }}>
          ...
          <h2 id="global-heading" style={{ color: "#fff" }}>
          ...
          >
            Per-capita CO₂e emissions by country. Click any country to learn
            more. Data: IEA 2024, World Bank 2023.
          </p>
        </div>
        ...
        >
          <div
            ...
            role="list"
            aria-label="Per-capita emissions by country"
          >
            {/* Paris target */}
            <div role="listitem">
              <div
              ...
              <div
                ...
                style={{ background: "var(--gray-700)", height: 6 }}
              >
                <div
                  className="progress-bar"
                  style={{
                    width: `${Math.round((PARIS_TARGET / maxVal) * 100)}%`,
            ...
            {hasCalculated && (
              <div role="listitem">
                ...
                <div
                  className="progress-track"
                  style={{ background: "var(--gray-700)", height: 12 }}
                >
                  <div
                    className="progress-bar"
                    style={{
                      ...
                      background:
                        userTotal <= BENCHMARKS.india
                          ? "var(--green-400)"
                          : userTotal <= BENCHMARKS.world
                          ? "#f59e0b"
                          : "#ef4444",
                      height: "100%",
            ...
            {REGIONS.map((region) => {
              ...
              return (
                <div
                  ...
                  onClick={() =>
                    setSelected((s) => (s === region.key ? null : region.key))
                  }
                ...
                >
                  <div
                    style={{
                      ...
                      fontSize: "0.875rem",
                      marginBottom: "var(--space-2)",
                      color: isSelected ? "#fff" : "var(--gray-300)",
                  ...
                  <div
                    className="progress-track"
                    style={{ background: "var(--gray-700)", height: 10 }}
                  >
                    <div
                      className="progress-bar"
                      style={{
                        ...
                        height: "100%",
                        transition: "width 0.8s ease, opacity var(--transition-fast)",
                      }}
                    />
                  </div>
                    ...
                    >
                      ...
                      {hasCalculated && (
                        ...
                        >
                          {userTotal < region.benchmark
                            ? `✓ Your footprint is ${(
                                (1 - userTotal / region.benchmark) *
                                100
                              ).toFixed(0)}% lower than ${region.name}.`
                            : `Your footprint is ${(
                                (userTotal / region.benchmark - 1) *
                                100
                              ).toFixed(0)}% higher than ${region.name}.`}
                        </span>
                      )}
                    </div>
                  )}
...
function ContextCard({ emoji, title, body }: ContextCardProps) {
  return (
    <div
      className="card"
      style={{
