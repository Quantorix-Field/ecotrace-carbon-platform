...
export default function Hero({ onStart }) {
  return (
    <section
      ...
      style={{
        background: "linear-gradient(160deg, var(--green-50) 0%, #fff 55%, var(--green-50) 100%)",
      ...
      <div className="container">
        ...
        >
          ...
          <div className="animate-fade-up">
            ...
            >
              {["Free & open-source", "No account needed", "Data stays on your device"].map(
                (t) => (
                  <span
                    key={t}
                    style={{
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: "0.875rem", color: "var(--green-100)", marginTop: 2 }}>
