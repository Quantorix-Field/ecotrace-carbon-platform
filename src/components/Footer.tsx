...
export default function Footer() {
  ...
  return (
    <footer
      style={{
        background: "var(--gray-950, #0a0f0d)",
      ...
      <div className="container" style={{ paddingBlock: "var(--space-12)" }}>
        ...
        >
          ...
          <div>
            ...
            >
              Science-backed carbon tracking for individuals. Understand your
              footprint. Act on what matters.
            </p>
      ...
      <div style={{ borderTop: "1px solid var(--gray-800)", paddingBlock: "var(--space-5)" }}>
        ...
        >
          <p style={{ fontSize: "0.8125rem", color: "var(--gray-600)", margin: 0 }}>
            ...
            ·{" "}
            <a
              href="https://github.com/Quantorix-Field/ecotrace-carbon-platform/blob/main/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                color: "var(--green-500)",
